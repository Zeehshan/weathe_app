...
abstract class $CityModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String admin1, String name, double latitude, double longitude});
}
...
class _$_CityModel implements _CityModel {
  ...
  @override
  String toString() {
    return 'CityModel(admin1: $admin1, name: $name, latitude: $latitude, longitude: $longitude)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, admin1, name, latitude, longitude);
...
abstract class _CityModel implements CityModel {
  factory _CityModel(
      ...
      required final double longitude}) = _$_CityModel;
